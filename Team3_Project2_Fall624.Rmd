...
Support vector machine (SVM) models are created using two kernels: radial and linear.
```{r svm}
library(kernlab)
...
The Cubist model also performs best as judged by the r-squared, and will be used for prediction.
